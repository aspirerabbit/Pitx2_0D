...
#define beats 24     /* Number of Beats */
#define S2  500
...
{       
   ...
   if (str3 == NULL){
	...
	sprintf(str3,"SERCA_%d_PI_%g.txt",int(Flecainide),PITX2);
   ...
   if (strfmax == NULL){
	...
	sprintf(strfmax,"APDSERCA_%d_PI_%g.txt",int(Flecainide),PITX2);
...
//	Ileak=Vleak*(CaSR-Cai);////////////////
	Iup=(1+1.0)*Vmaxup/(1.+((Kup*Kup)/(cai*cai)));///////////////
