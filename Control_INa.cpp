...
{       
   ...
   if (str3 == NULL){
	...
	sprintf(str3,"INa_%d_PI_%g.txt",int(Flecainide),PITX2);
   ...
   if (strfmax == NULL){
	...
	sprintf(strfmax,"APDINa_%d_PI_%g.txt",int(Flecainide),PITX2);
...
void comp_ina ()
{
        gna = (1+0.1)*7.8*(1-AF*0.1)*(1.0/(1.0+Flecainide/84.0));//PITX2
