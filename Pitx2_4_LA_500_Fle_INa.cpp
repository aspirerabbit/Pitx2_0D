...
#define beats 70     /* Number of Beats */
#define S2  500
...
{       
   ...
   if (str3 == NULL){
	...
	sprintf(str3,"LA4INA_Fe_%d_PI_%g.txt",int(Flecainide),PITX2);
   ...
   if (strfmax == NULL){
	...
	sprintf(strfmax,"APD4INA_Fe_%d_PI_%g.txt",int(Flecainide),PITX2);
...
void comp_ikr ()
{
       gkr = 0.0294*(1+LA*0.6)*(1+RA*0.0)*sqrt(ko/5.4);
