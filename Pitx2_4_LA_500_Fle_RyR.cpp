...
{       
   ...
   if (str3 == NULL){
	...
	sprintf(str3,"LA4RYR_Fe_%d_PI_%g.txt",int(Flecainide),PITX2);
   ...
   if (strfmax == NULL){
	...
	sprintf(strfmax,"APD4RYR_Fe_%d_PI_%g.txt",int(Flecainide),PITX2);
...
void comp_ina ()
{
        gna = (1+PITX2*0.1)*7.8*(1-AF*0.1);//PITX2
